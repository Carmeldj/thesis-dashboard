    ...
    return (
      <Layout>
        <div className="flex items-center justify-center h-full">
          <div className="text-xl text-slate-400">Loading shops...</div>
        </div>
      </Layout>
    );
  }
  ...
  return (
    <Layout>
      <div>
        ...
        <p className="text-slate-400 mb-6">Manage and activate shop accounts</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-slate-800 rounded-lg shadow-xl border border-slate-700 p-4">
            ...
            <p className="text-2xl font-bold text-slate-100">{shops.length}</p>
          </div>
          <div className="bg-slate-800 rounded-lg shadow-xl border border-slate-700 p-4">
        ...
        {filteredShops.length === 0 ? (
          <div className="bg-slate-800 rounded-lg shadow-xl border border-slate-700 p-8 text-center text-slate-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredShops.map((shop) => (
              <div
                key={shop.id}
                className="bg-slate-800 rounded-lg shadow-xl border border-slate-700 hover:shadow-2xl hover:border-slate-600 transition overflow-hidden"
              >
                <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-400">IFU: {selectedShop.ifu}</p>
                    </div>
                  </div>
