...
export const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-slate-100 to-slate-200">
      <div className="bg-white p-8 rounded-lg shadow-2xl border border-slate-200 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input
              ...
              required
              disabled={isLoading}
              className="w-full px-4 py-2 bg-slate-50 border border-slate-300 text-slate-900 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition disabled:opacity-50 disabled:cursor-not-allowed placeholder-slate-500"
